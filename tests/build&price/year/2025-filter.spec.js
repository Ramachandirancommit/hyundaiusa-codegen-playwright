...
test('Build & Price - Verify 2025 PALISADE Flow', async ({ page }) => {
  ...
  // ───────────────────────────────
  // Step 3: Select 2025 Checkbox
  // ───────────────────────────────
  const year2025Checkbox = page.locator('#Year-2025');

  await expect(year2025Checkbox).toBeVisible();
  console.log('✔ 2025 checkbox visible');
  await page.waitForTimeout(2000);

  await year2025Checkbox.check();
  console.log('✔ 2025 checkbox selected');
  await page.waitForTimeout(5000);
  ...
  console.log('\n🎉 2025 PALISADE Flow Test Completed Successfully 🎉');
});